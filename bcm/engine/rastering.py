...
class RasterCollector(gobject.GObject):
        ...
        try:
            ...
            for cell, cell_loc in self.grid_cells.items():
                ...
                frame = {
                    ...
                    'wavelength': energy_to_wavelength(self.beamline.energy.get_position()),
                ...
                self.beamline.detector.set_parameters(frame)
    ...
    def analyse_image(self, cell_params=None):
        ...
        self.beamline.dpm.service.callRemote(
            ...
            self._result_ready, callbackArgs=[cell],

...
from mxdc.interface.devices import IGoniometer
from twisted.python.components import globalRegistry
from mxdc.interface.beamlines import IBeamline
from mxdc.com import ca
from mxdc.device.motor import PseudoMotor
from mxdc.device.misc import Positioner, BasicShutter
...
class GoniometerBase(BaseDevice):
    ...
    __gsignals__ =  { 
        "mode": (GObject.SignalFlags.RUN_FIRST, None, (GObject.TYPE_PYOBJECT,)),
        } 

...
class App(object):
    ...
    def setup(self):
        ...
        try:
            ...
            self.browser = mdns.Browser('_cmcf_mxdc._tcp')
    ...
    def on_bcm_connected(self, perspective):
        ...
        info = {'prefix':'xtl123', 
                ...
                'energy':12.0,
                'edge': 'Se-K'}
#        self.mxdc.callRemote('scanEdge',
#                            info,
#                            directory='/users/cmcfadmin/08B1-20101026-a4df2030/xtl123/scan',
#                            uname='cmcfadmin',
#                            ).addCallback(self.dump_results).addErrback(self.dump_error)

        self.mxdc.callRemote('getParameters').addCallback(self.dump_results).addErrback(self.dump_error)
#        self.mxdc.callRemote('takeSnapshots',
#                            'test_snapshot',  [0,90], 
#                            '/home/michel/Desktop', 'michel',                           
#                            ).addCallback(self.dump_results).addErrback(self.dump_error)

        #self.mxdc.callRemote('mountSample', 'LC2', 'xtal1').addCallback(self.dump_results).addErrback(self.dump_error)
        self.mxdc.callRemote('acquireFrames', 
                            run_info, 
...
#        self.mxdc.callRemote('setupCrystal', 
#                            'xtl123',

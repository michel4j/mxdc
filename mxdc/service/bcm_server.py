...
from mxdc.engine import diffraction
from mxdc.engine import spectroscopy
from mxdc.utils import science, mdns
from mxdc.service.utils import log_call, defer_to_thread, send_array
from mxdc.interface.services import IPerspectiveBCM, IBCMService
from mxdc.engine.snapshot import take_sample_snapshots
from mxdc.utils.log import log_to_twisted
from mxdc.utils.misc import get_short_uuid
from mxdc.utils import runlists
from mxdc.service.common import *
from mxdc.engine import auto
from mxdc.utils import converter, json
...
try:
    bcm_provider = mdns.Provider('Beamline Control Module', '_cmcf_mxdc._tcp', 8880, {}, unique=True)

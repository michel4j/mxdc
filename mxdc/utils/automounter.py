...
SAM_LAYOUTS = {
    ('MA', 'puck'): (0.4167, 0.5208),
    ('MD', 'puck'): (0.5000, 0.6667),
    ('LD', 'puck'): (0.3333, 0.3750),
    ('LB', 'puck'): (0.1667, 0.3750),
    ('LC', 'puck'): (0.2500, 0.2292),
    ('MC', 'puck'): (0.5833, 0.5208),
    ('LA', 'puck'): (0.0833, 0.2292),
    ('MB', 'puck'): (0.3333, 0.6667),
    ('RD', 'puck'): (0.8333, 0.3750),
    ('RA', 'puck'): (0.7500, 0.2292),
    ('RB', 'puck'): (0.6667, 0.3750),
    ('RC', 'puck'): (0.9167, 0.2292),

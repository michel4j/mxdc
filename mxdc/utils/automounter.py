...
ISARA_DEWAR = {
    '1A': Puck('1A', 0.1667, 1.5 / 13.),
    '2A': Puck('2A', 0.3333, 1.5 / 13.),
    '3A': Puck('3A', 0.5, 1.5 / 13.),
    '4A': Puck('4A', 0.6667, 1.5 / 13.),
    '5A': Puck('5A', 0.8333, 1.5 / 13.),

    '1B': Puck('1B', 0.0833, 3.5 / 13.),
    '2B': Puck('2B', 0.25, 3.5 / 13.),
    '3B': Puck('3B', 0.4167, 3.5 / 13),
    '4B': Puck('4B', 0.5833, 3.5 / 13),
    '5B': Puck('5B', 0.75, 3.5 / 13),
    '6B': Puck('6B', 0.9167, 3.5 / 13),

    '1C': Puck('1C', 0.1667, 5.5 / 13),
    '2C': Puck('2C', 0.3333, 5.5 / 13),
    '3C': Puck('3C', 0.5, 5.5 / 13),
    '4C': Puck('4C', 0.6667, 5.5 / 13),
    '5C': Puck('5C', 0.8333, 5.5 / 13),

    '1D': Puck('1D', 0.0833, 7.5 / 13.),
    '2D': Puck('2D', 0.25, 7.5 / 13),
    '3D': Puck('3D', 0.4167, 7.5 / 13),
    '4D': Puck('4D', 0.5833, 7.5 / 13),
    '5D': Puck('5D', 0.75, 7.5 / 13),
    '6D': Puck('6D', 0.9167, 7.5 / 13),

    '1E': Puck('1E', 0.1667, 9.5 / 13),
    '2E': Puck('2E', 0.3333, 9.5 / 13),
    '3E': Puck('3E', 0.5, 9.5 / 13),
    '4E': Puck('4E', 0.6667, 9.5 / 13),
    '5E': Puck('5E', 0.8333, 9.5 / 13),

    '1F': Puck('1F', 0.4167, 11.5 / 13),
    '2F': Puck('2F', 0.5833, 11.5 / 13),

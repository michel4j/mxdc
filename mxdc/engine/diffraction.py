...
class DataCollector(GObject.GObject):
    ...
    __gsignals__ = {}
    __gsignals__['new-image'] = (GObject.SignalFlags.RUN_LAST, None, (GObject.TYPE_INT, GObject.TYPE_STRING))
    __gsignals__['progress'] = (GObject.SignalFlags.RUN_LAST, None, (GObject.TYPE_FLOAT, GObject.TYPE_INT, GObject.TYPE_INT))
    __gsignals__['done'] = (GObject.SignalFlags.RUN_LAST, None, [])
    __gsignals__['paused'] = (GObject.SignalFlags.RUN_LAST, None, (GObject.TYPE_BOOLEAN, GObject.TYPE_PYOBJECT))
...
class Screener(GObject.GObject):
    ...
    __gsignals__['started'] = (GObject.SignalFlags.RUN_LAST, None, [])
    __gsignals__['stopped'] = (GObject.SignalFlags.RUN_LAST, None, [])
    __gsignals__['sync'] = (GObject.SignalFlags.RUN_LAST, None, (GObject.TYPE_BOOLEAN, GObject.TYPE_STRING))
    __gsignals__['error'] = (GObject.SignalFlags.RUN_LAST, None, (GObject.TYPE_STRING,))
    __gsignals__['analyse-request'] = (GObject.SignalFlags.RUN_LAST, None, (GObject.TYPE_PYOBJECT,))
    __gsignals__['new-datasets'] = (GObject.SignalFlags.RUN_LAST, None, (GObject.TYPE_PYOBJECT,))
